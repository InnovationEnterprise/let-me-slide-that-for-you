...
gulp.task('lint', function() {
  gulp.src(['js/var.js', 'js/helpers.js', 'js/create.js',  'js/loadjson.js', 'js/preloader.js', 'js/playlist.js', 'js/video.js', 'js/getslides.js', 'js/setslide.js', 'js/setsize.js', 'js/loadimages.js', 'js/sliderclickevent.js', 'js/share.js', 'js/setcontent.js', 'js/fullscreen.js', 'js/config.js'])
    .pipe(jshint())
